...
public class StandardMessage {
    ...
    public void printMessage(StandardMessage message, Player player){

        MessageSender sender = message.getMessageType();

        switch(sender){
            case PLAYER -> {
                Validate.notNull(player);

                player.sendMessage(ChatUtils.component(getByKey(message).get()));
            }
            ...
            case CONSOLE -> {
                ...
                consoleCommandSender.sendMessage(ChatUtils.component(getByKey(message).get()));
            }
        }
    }
